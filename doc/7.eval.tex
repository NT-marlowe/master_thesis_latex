...
\begin{figure}[h]
  ...
  \end{minipage}
  \caption{Match rates by original file size. Results from the preliminary and main experiments are compared.
    In the left figure the horizontal axis is presented on a common logarithmic scale.}
\end{figure}
